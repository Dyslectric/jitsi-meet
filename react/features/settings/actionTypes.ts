 ...
 */
export const SET_SCREENSHARE_SETTINGS_VISIBILITY = 'SET_SCREENSHARE_SETTINGS_VISIBILITY';

/**
 * The type of (redux) action which sets the visibility of the video settings.
 */
